                            ...
                            <div class="bs-stepper-content">
                                ...
                                <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                                    <div class="form-group {{$errors->has('nombre') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre completo" required=""  value="{{old('nombre')}}">
                                    ...
                                    <div class="form-group {{$errors->has('fecha_nacimiento') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required="" value="{{old('fecha_nacimiento')}}" placeholder="Fecha de nacimiento">
                                            </div>
                                    ...
                                    <div class="form-group {{$errors->has('edad') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" id="edad" name="edad" class="form-control" required=""  placeholder="edad" value="{{old('edad')}}" data-mask>
                                    ...
                                    <div class="form-group {{$errors->has('nacionalidad') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="nacionalidad" name="nacionalidad" class="form-control" required=""  placeholder="nacionalidad" value="{{old('nacionalidad')}}">
                                    ...
                                    <div class="form-group {{$errors->has('telefono') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" id="telefono" name="telefono" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask required="" value="{{old('telefono')}}" placeholder="telefono de contacto">
                                    ...
                                    <div class="form-group {{$errors->has('correo') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" id="correo" name="correo" class="form-control" placeholder="Correo Electronico" required="" value="{{old('correo')}}">
                                ...
                                <div id="information-part-2" class="content" role="tabpanel" aria-labelledby="information-part-2-trigger">
                                    ...
                                    <div class="form-group {{$errors->has('partidos') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" id="partidos" name="partidos" class="form-control" placeholder="cantidad de partidos" value="{{old('partidos')}}">
                                    ...
                                    <div class="form-group {{$errors->has('goles') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" id="goles" name="goles" class="form-control" placeholder="cantidad de goles" value="{{old('goles')}}">
