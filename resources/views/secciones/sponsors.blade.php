        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="sponsors-carousel">
                    ...
                    <li style="padding-left:2em"><a href="#"><img src="{{asset('img/sponsors/sponsor02.png')}}" alt=""></a></li>
                    <li style="padding-left:2em"><a href="#"><img src="{{asset('img/sponsors/sponsor04.png')}}" alt=""></a></li>
                </ul>
            </div>
        </div>
    </div>
