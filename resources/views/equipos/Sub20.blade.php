...
<div class="section-title-team">
    ...
    <div class="bg-image-team" style="background:url({{asset('img/clubs-teams/sub20.jpg')}});"></div>
</div>
<!-- End Section Title -->
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-md-12">
                    ...
                    <ul class="nav nav-tabs" id="myTab">
                        ...
                        <li><a href="#plantilla" data-toggle="tab">Plantilla</a></li>
                ...
                <div class="col-lg-9 padding-top-mini">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="overview">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="clear-title">Noticias Juveniles</h3>
                                </div>
