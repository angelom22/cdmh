...
<div class="section-title-team">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <ul class="general-info">
                            ...
                            <li>
                                <h6><strong>Dt:</strong> Pedro Celis</h6>
                            </li>
                            <!-- <li><h6><strong>Total Titles:</strong> 100+</h6></li> -->
                            <li>
                                <h6><strong>Categoía:</strong> Sub 18</h6>
                            </li>
                            <li>
    ...
    <div class="bg-image-team" style="background:url({{asset('img/clubs-teams/sub18.jpg')}});"></div>
</div>
<!-- End Section Title -->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="overview">
                            ...
                            <div class="panel-box padding-b">
                                <div class="titles">
                                    <h4>Categoría Sub18</h4>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-xl-4">
                                        <img src="{{asset('img/clubs-teams/sub18.jpg')}}" alt="">
                                    </div>
