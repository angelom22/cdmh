                                        ...
                                        <div class="form-group {{$errors->has('fecha_nacimiento') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required="" value="{{old('fecha_nacimiento', $jugador->fecha_nacimiento->format('d-m-y') )}}"  placeholder="Fecha de nacimiento">
                                                </div>
                                        ...
                                        <div class="form-group {{$errors->has('nombre') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="col-sm-5">
                                                    ...
                                                    <img class="card-img-top img-responsive" src="{{asset($jugador->imagen->url)}}" alt="{{$jugador->nombre}}">
                                                </div>
                                                <div class="col-sm-5">
                                                    <!-- <div class="dropzone"> -->
